...
; int count(int *array, int sentinel)
; Functional subprogram that returns the count of the number of ?non-sentinel? values stored in the leading elements of the given array.

cnt_ary:   .EQUATE   2 ; pass in either positive or negative array
sentinel:  .EQUATE   4

start:     LDWX    0,i
traverse:  LDWA    cnt_ary,sfx ; traverse through array, keep adding 1 to the count
           CPWA    sentinel,s 
           BREQ    done ; once the array value is 0, stop and return count
           ADDX    2,i
           BR      traverse
done:      ASRX
           STWX    -2,s
